 ...
 * @author ADMIN
 */
public class Register_Action1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!isMultipart) {
            ...
            while (itr.hasNext()) {
                ...
                if (item.isFormField()) {
                    ...
                    savedFile = new File(sc.getRealPath("dprofile") + "\\" + finalimage);
                    try {
        ...
        try {
            ...
            PreparedStatement query = con.prepareStatement("insert into dregister(simage,sno,sname,pass,mail,mobile,dob,ano,ifsc,micr,brach,address)values ('" + ms.get(0) + "','" + m.get(0) + "','" + m.get(1) + "','" + m.get(2) + "','" + m.get(3) + "','" + m.get(4) + "','" + m.get(5) + "','" + m.get(6) + "','" + m.get(7) + "','" + m.get(8) + "','" + m.get(9) + "','" + m.get(10) + "')");
