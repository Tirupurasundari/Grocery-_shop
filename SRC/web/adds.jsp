...
%>
                        ...
                        <h2 align="center" style="color: orangered;  font-weight: bold; font-size: 30px;"><img src="dprofile/<%=image%>" alt="logo" style="height: 100px; width: 100px; border-radius: 30px;">&nbsp;&nbsp;Salary Credit by <%=sname%> </h2><br>
                        <tr align="center"><td>D-NO </td><td><input type="text" name="sno" value="<%=sno%>" readonly=""></td></tr>
                        <tr align="center"><td>D Name </td><td><input type="text" name="sname" value="<%=sname%>" readonly=""></td></tr>
                        <tr align="center"><td>D-Mail</td><td><input type="text" name="mail" value="<%=mail%>" style="heigth:200px;" readonly=""></td></tr>
                        <tr align="center"><td>Mobile</td><td><input type="text" value="<%=mobile%>" name="mobile" readonly=""></td></tr>
                        <tr align="center"><td>A/No</td><td><input type="text" value="<%=ano%>" name="ano" readonly=""></td></tr>
                        <tr align="center"><td>IFSC</td><td><input type="text" value="<%=ifsc%>" name="ifsc" readonly=""></td></tr>
                        <tr align="center"><td>MICR</td><td><input type="text" value="<%=micr%>" name="micr" readonly=""></td></tr>
                        <tr align="center"><td>Brach</td><td><input type="text" value="<%=brach%>" name="brach" readonly=""></td></tr>
                        <tr align="center"><td>Address</td><td><input type="text" value="<%=address%>" name="address" readonly=""></td></tr>
                        <tr align="center"><td>Salary Amount</td><td><input type="text" value=" " name="tcost" requried=""></td></tr>
