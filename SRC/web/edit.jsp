...
%>
                        ...
                        <table align="center">
                        <h2 align="center" style="color: orangered;  font-weight: bold; font-size: 30px;"><img src="images/<%=fimage%>" alt="logo" style="height: 100px; width: 100px; border-radius: 30px;">&nbsp;&nbsp;Edit  Item </h2><br>
                        <tr align="center"><td> NO </td><td><input type="text" name="fno" value="<%=fno%>" readonly=""></td></tr>
                        <tr align="center"><td> Name </td><td><input type="text" name="fname" value="<%=fname%>" readonly=""></td></tr>
                        <tr align="center"><td> Description</td><td><input type="text" name="fdes" value="<%=fdes%>" style="heigth:200px;" requried=""></td></tr>
                        ...
                        <tr align="center"><td>Status</td><td><select name="status" requried="" style="width:300px;">
                         ...
                         <tr align="center"><td>Quantity</td><td><input type="text" value="<%=ready%>" name="ready" requried=""></td></tr>
                          <tr align="center"><td>Name</td><td><input type="text" value="<%=tableName%>" name="ftableName" requried=""></td></tr>
