...
try {
                    ...
                    PreparedStatement query=con.prepareStatement("update dregister set tcost='"+tcost+"' where sname='"+sname+"' and sno='"+sno+"' and id='"+id+"'");
                    query.executeUpdate();
                    ...
                    RequestDispatcher rd=request.getRequestDispatcher("Addsalar.jsp");
