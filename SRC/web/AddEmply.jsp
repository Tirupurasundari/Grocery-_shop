...
<!-- banner -->
	<div class="banner">      
		...
		<div class="w3l_banner_nav_right">
			...
			<h3 align="center" style="color: red; font-family:cursive;">Add Employee</h3>
			<div class="w3_login_module">
				<div class="module form-module">
				  <div class="toggle"><i class="fa fa-times fa-pencil"></i>
                                   ...
                                   <div class="form">
					<h2>Create an account for Delivery Boy</h2>
					<form action="Register_Action1" method="post" enctype="multipart/form-data">
					  <strong style="font-weight: 5px;">Profile</strong><input type="file" name="image" placeholder="Profile" required=" "><br>
					  
					  <input type="text" name="sno" placeholder="Employee ID" required=" ">
                                          <input type="text" name="user" placeholder="Employee name" required=" ">
					  <input type="password" name="pass" placeholder=" password"required=" ">
                                          <input type="email" name="email" placeholder="Email Address" pattern="[^@\s]+@[^@\s]+\.[^@\s]+"required=" ">
					  <input type="text" name="mobile" pattern="[6789][0-9]{9}"placeholder="Phone Number" title="Enter 10-digits (starts with 6,7,8,9)"maxlength="10" required=" ">
                                          <input type="date" name="dob" required style="line-height: 34px;margin-bottom: 24px;">
					  <input type="text" name="ano" placeholder="Account Number" required=" ">
                                          <input type="text" name="ifsc" placeholder="IFSC Code" required=" ">
					  <input type="text" name="micr" placeholder="MICR Number" required=" ">
                                          <input type="text" name="brach" placeholder="Brach Name" required=" ">
