...
%>
                        <form action="editaction1.jsp">                     
                        <table align="center">
                            <input type="hidden" name="image" value="<%=image%>" >
                            <input type="hidden" name="id" value="<%=id%>">
                        <h2 align="center" style="color: orangered;  font-weight: bold; font-size: 30px;"><img src="dprofile/<%=image%>" alt="logo" style="height: 100px; width: 100px; border-radius: 30px;">&nbsp;&nbsp;Edit <%=sname%> </h2><br>
                        ...
                        <tr align="center"><td>D-Mail</td><td><input type="text" name="mail" value="<%=mail%>" style="heigth:200px;" requried=""></td></tr>
                        <tr align="center"><td>Mobile</td><td><input type="text" value="<%=mobile%>" name="mobile" requried=""></td></tr>
                        <tr align="center"><td>A/No</td><td><input type="text" value="<%=ano%>" name="ano" requried=""></td></tr>
                        <tr align="center"><td>IFSC</td><td><input type="text" value="<%=ifsc%>" name="ifsc" requried=""></td></tr>
                        <tr align="center"><td>MICR</td><td><input type="text" value="<%=micr%>" name="micr" requried=""></td></tr>
                        <tr align="center"><td>Brach</td><td><input type="text" value="<%=brach%>" name="brach" requried=""></td></tr>
                        <tr align="center"><td>Address</td><td><input type="text" value="<%=address%>" name="address" requried=""></td></tr>
