...
<!-- banner -->
	...
	<div class="w3l_banner_nav_right">  
        ...
        <div class="header-text">
            <h2 align="center" style=" color:orange; margin-top: 5%; font-family: cursive;font-weight: bold; font-size: 30px;">View & Update Employee !</h2><br><br>
  ...
  <%                    
       ...
       <tr><td><img src="dprofile/<%=rs.getString("simage")%>" alt="" style="width: 90px; height: 90px; border-radius: 50px;"></td>
                            ...
                            <td style="color: green"><%=rs.getString("dob")%></td>    
                            <td>Brach: <%=rs.getString("brach")%>,<br>A/No: <%=rs.getString("ano")%>,<br>IFSC: <%=rs.getString("ifsc")%>, <br>MICR: <%=rs.getString("micr")%></td>    
                            <td style="width:200px;"><a href="delete1.jsp?sno=<%=rs.getString("sno")%>" style="color: #a367e7;">Delete</a>&nbsp;/&nbsp;<a href="edit1.jsp?id=<%=rs.getString("id")%>&&simage=<%=rs.getString("simage")%>&&pname=<%=rs.getString("sname")%>&&sno=<%=rs.getString("sno")%>&&ano=<%=rs.getString("ano")%>&&ifsc=<%=rs.getString("ifsc")%>&&mail=<%=rs.getString("mail")%>&&micr=<%=rs.getString("micr")%>&&brach=<%=rs.getString("brach")%>&&address=<%=rs.getString("address")%>&&mobile=<%=rs.getString("mobile")%>" style="color: #a367e7;">Edit</a>&nbsp;/<a href="enable1.jsp?sno=<%=rs.getString("sno")%>&&id=<%=rs.getString("id")%>" style="color: #a367e7;">Enable</a></td>
                            </tr> <%}%>   </table>   
                    <br><br><br><br></div></div>
				</div>
