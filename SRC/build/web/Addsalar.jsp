...
<!-- banner -->
	...
	<div class="w3l_banner_nav_right">  
        ...
        <div class="header-text">
            <h2 align="center" style=" color:orange; margin-top: 5%; font-family: cursive;font-weight: bold; font-size: 30px;">View & Salary Credit for Employee !</h2><br><br>
  ...
  <%                    
       ...
       <tr><td><img src="dprofile/<%=rs.getString("simage")%>" alt="" style="width: 90px; height: 90px; border-radius: 50px;"></td>
                            ...
                            <td style="width:200px;"><button><a href="adds.jsp?id=<%=rs.getString("id")%>&&simage=<%=rs.getString("simage")%>&&pname=<%=rs.getString("sname")%>&&sno=<%=rs.getString("sno")%>&&ano=<%=rs.getString("ano")%>&&ifsc=<%=rs.getString("ifsc")%>&&mail=<%=rs.getString("mail")%>&&micr=<%=rs.getString("micr")%>&&brach=<%=rs.getString("brach")%>&&address=<%=rs.getString("address")%>&&mobile=<%=rs.getString("mobile")%>" style="color: #a367e7;">Credit</a>&nbsp;</button></td>
                            </tr> <%}%>   </table>   
                    <br><br><br><br></div></div>
				</div>
