<%-- 
    Document   : Viewmenu3
    Created on : 14 May, 2024, 9:26:30 PM
    Author     : ACER
--%>
...
<!--						<li><a href="Profile.jsp">Profile</a></li>                                                
	...
	<div class="w3l_banner_nav_right">  
            <div class="w3ls_w3l_banner_nav_right_grid">
                        ...
                        PreparedStatement query=con.prepareStatement("select * from fruits ");
								...
								<figure> 
									<div class="snipcart-item block" style="height: 350px; padding-bottom: 10px;">
										...
										<div class="snipcart-details">
                                                                                    ...
                                                                                    <a href="order.jsp?fimage=<%=image%>&&fname=<%=rs.getString("fname")%>&&ftableName=fruits&&fdes=<%=rs.getString("fdes")%>&&cost=<%=rs.getString("cost")%>&&ready=<%=rs.getString("ready")%>"><button style="color:white;   background: red; border-radius: 15px; height: 40px; width:170px;">Add to Cart</button></a>
