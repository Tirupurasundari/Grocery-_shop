		...
		<div class="w3l_banner_nav_right">
		 <style>
                    ...
                    table{
                        ...
                        <h3 align="center" style="font-weight:bold; color:#f71926; font-size: 30px;">View all Delivery Boy Work</h3>
                    ...
                    <table> <tr>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from orders where not status='Waiting'");
