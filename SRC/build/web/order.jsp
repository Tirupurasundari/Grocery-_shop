	...
	<div class="banner">      
		...
		<div class="w3l_banner_nav_right">
			...
			<form action="orderaction.jsp">                     
                        <h2 align="center" style="color: orangered;  font-weight: bold; font-size: 30px;"><img src="images/<%=fimage%>" alt="logo" style="height: 100px; width: 100px; border-radius: 30px;">&nbsp;Your Order </h2><br>
                        <table align="center">
                        <tr align="center"><td>Product Name </td><td><input type="text" name="fname" value="<%=fname%>" readonly=""></td></tr>
                             <input type="text" name="ftableName" value="<%=ftableName%>" readonly="" style="display:none;">
                        <tr align="center"><td>Product Description</td><td><input type="text" name="fdes" value="<%=fdes%>" style="heigth:200px;" readonly=""></td></tr>
                        <tr align="center"><td>Cost </td><td><input type="text" value="<%=cost%>" name="cost" readonly=""></td></tr>
                        <tr align="center"><td>Available</td><td><input type="text" value="<%=ready%>" name="ready" readonly=""></td></tr>
