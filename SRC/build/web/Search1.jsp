		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					...
					<li><a href="about.html" style="font-family: cursive; font-size: 20px; font-weight: bold;">About Us</a><i>/</i></li>
					<li><a href="services.html" style="font-family: cursive; font-size: 20px; font-weight: bold;">Services</a></li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left1">
...
<!-- banner -->
	<div class="w3l_banner_nav_right">  
            <div class="w3ls_w3l_banner_nav_right_grid" style="margin-left: -175px;"><br><br>
                        <h3>View all Product Add to Cart</h3>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from "+tableName+" where fname='"+pro+"'");
								...
								<figure> 
									<div class="snipcart-item block" style="height: 350px; padding-bottom: 10px;">
										...
										<div class="snipcart-details">
                                                                                    ...
                                                                                    <a href="CustomerLogin.jsp"><button style="color:white;   background: red; border-radius: 15px; height: 40px; width:170px;">Add to Cart</button></a>
