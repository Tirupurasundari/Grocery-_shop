		 ...
		 <style>
                    ...
                    <table> <tr><th>Product</th>
                        ...
                        <tr><td><img src="images/<%=image%>" alt="" style="width: 90px; height: 90px; border-radius: 50px;"></td>
                            ...
                            <td><a href="delivery.jsp?id=<%=rs.getString("id")%>&&sid=<%=rs.getString("sid")%>&&sname=<%=rs.getString("sname")%>&&fname=<%=rs.getString("fname")%>" style="color:red;width:100px;">Click Here to Delivery</a></td><%}%></tr>
                    </table>
                    <br><br><br><br></div>
